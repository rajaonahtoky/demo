        ...
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    ...
                    this.snapshotChangesSubscription = this.afs.collection('users').doc(currentUser.uid).collection('interventions').snapshotChanges();
    ...
    getIntervention(interventionId) {
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    // tslint:disable-next-line:max-line-length
                    this.snapshotChangesSubscription = this.afs.doc('users/' + currentUser.uid + '/interventions/' + interventionId).valueChanges()
                        .subscribe(snapshots => {
                        resolve(snapshots);
                    }, err => {
                        reject(err);
    ...
    getShops() {
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    // tslint:disable-next-line:max-line-length
                    this.snapshotChangesSubscription = this.afs.collection('shops').snapshotChanges();
                    resolve(this.snapshotChangesSubscription);
                }
            });
        });
    ...
    getEntretiens() {
        return new Promise((resolve, reject) => {
            this.afAuth.user.subscribe(currentUser => {
                if (currentUser) {
                    // tslint:disable-next-line:max-line-length
                    this.snapshotChangesSubscription = this.afs.collection('entretiens').snapshotChanges();
                    resolve(this.snapshotChangesSubscription);
                }
            });
        });
...
//# sourceMappingURL=default~entretien-entretien-module~sav-sav-module~shop-shop-module-es2015.js.map