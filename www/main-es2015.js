...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'email',
                loadChildren: () => Promise.all(/*! import() | pages-login-email-login-email-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-login-email-login-email-module")]).then(__webpack_require__.bind(null, /*! ./pages/login-email/login-email.module */ "./src/app/pages/login-email/login-email.module.ts")).then(m => m.LoginEmailPageModule)
            },
            {
                path: 'intro',
                loadChildren: () => Promise.all(/*! import() | pages-login-intro-login-intro-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-login-intro-login-intro-module")]).then(__webpack_require__.bind(null, /*! ./pages/login-intro/login-intro.module */ "./src/app/pages/login-intro/login-intro.module.ts")).then(m => m.LoginIntroPageModule)
            },
            {
                path: 'lost-password',
                loadChildren: () => __webpack_require__.e(/*! import() | pages-lost-password-lost-password-module */ "pages-lost-password-lost-password-module").then(__webpack_require__.bind(null, /*! ./pages/lost-password/lost-password.module */ "./src/app/pages/lost-password/lost-password.module.ts")).then(m => m.LostPasswordPageModule)
            }
        ]
    },
    {
...
module.exports = __webpack_require__(/*! /Users/macbookpro2015/ionic-workspace/piscinadom/src/main.ts */"./src/main.ts");
